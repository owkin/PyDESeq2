...
As PyDESeq2 is a re-implementation from scratch, you may experience some differences compared with [DESeq2](https://bioconductor.org/packages/release/bioc/html/DESeq2.html),
in terms of retrieved values or available features.
